 ...
 * Created by Faruq on 10/25/2016.
 */
public class AirtelMiscAdapter extends RecyclerView.Adapter<AirtelMiscAdapter.AirtelViewHolder> {
    ...
    public AirtelMiscAdapter(Context context) {
        mContext = context;
        mmContext=context;
    ...
    public AirtelViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.airtel_misc_layout, parent, false);
    ...
    public void onBindViewHolder(final AirtelViewHolder holder, int position) {
                ...
                if(AppsSettings.getAppsSettings(mContext).getLanguage().equals("eng"))
                {
                    ...
                    ab.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            WHelper.getInstance(mContext).DialingCode("*121*2*4#");
                        }
                    });
        ...
        holder.btn_missed_call_alert_stop.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                WHelper.getInstance(mContext).DialingCode("*121*3*4#");
            }
        });
    ...
    private void convertEnglish(AirtelViewHolder holder) {
        ...
        holder.gp_btn_your_no.setText("" + mContext.getResources().getString(R.string.btn_check));
    ...
    private void convertBangla(AirtelViewHolder holder) {
        ...
        holder.gp_btn_your_no.setText("" + mContext.getResources().getString(R.string.btn_check_bn));
    ...
    public static class AirtelViewHolder extends RecyclerView.ViewHolder {
        public CardView cv;
        public Button btn_balance, btn_menu, gp_btn_emergency_balance, btn_internet_balance_check, gp_btn_your_no, btn_missed_call_alert_start, btn_missed_call_alert_stop;
        public TextView self_care_prepaid, balance_inquiry_prepaid, emergency_balance, internet_balance, own_number, missed_call_alert, missed_call_alert_1;
