...
public class AirtelPostpaidFragment extends Fragment {
    public static RecyclerView recyclerView;
    public Context mContext;
    AirtelPostpaidAdapter airtelAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        AirtelPostpaidFragment.MyAsyncTask myAsyncTask = new AirtelPostpaidFragment.MyAsyncTask();
        myAsyncTask.execute();
    ...
    public class MyAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            airtelAdapter = new AirtelPostpaidAdapter(mContext, AppManager.mAirtelPostpaidDataPackList, false);
