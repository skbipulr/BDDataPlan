...
import com.walton.internetdataplan.adapters.BLFnFServiceAdapter;
...
public class BLFnFFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        BLFnFServiceAdapter mAdapter = new BLFnFServiceAdapter(mContext);
