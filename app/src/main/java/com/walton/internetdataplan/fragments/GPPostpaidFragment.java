...
public class GPPostpaidFragment extends Fragment {
    public static RecyclerView recyclerView;
    public Context mContext;
    GPPostpaidAdapter gpAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.gp_recycler_layout, container, false);
    ...
    public class MyAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            gpAdapter = new GPPostpaidAdapter(mContext, AppManager.mGPPostpaidDataPackList, false);
            recyclerView.setAdapter(gpAdapter);
