...
import com.walton.internetdataplan.adapters.GPMusicAdapter;
...
public class GPMusicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GPMusicAdapter gpAdapter=new GPMusicAdapter(mContext);
