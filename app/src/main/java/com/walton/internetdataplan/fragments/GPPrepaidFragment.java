...
public class GPPrepaidFragment extends Fragment {
    public static RecyclerView recyclerView;
    public Context mContext;
    GPPrepaidAdapter gpAdapter;
    ...
    public class MyAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            gpAdapter = new GPPrepaidAdapter(mContext, AppManager.mGPPrepaidDataPackList, false);
