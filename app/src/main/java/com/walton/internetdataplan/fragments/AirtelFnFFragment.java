...
import com.walton.internetdataplan.adapters.AirtelFnFServiceAdapter;
...
public class AirtelFnFFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        AirtelFnFServiceAdapter mAdapter = new AirtelFnFServiceAdapter(mContext);
