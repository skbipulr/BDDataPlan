...
import com.walton.internetdataplan.adapters.GPFnFServiceAdapter;
...
public class GPFnFFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        GPFnFServiceAdapter gpAdapter=new GPFnFServiceAdapter(mContext);
