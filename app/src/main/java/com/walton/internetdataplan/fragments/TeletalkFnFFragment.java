...
import com.walton.internetdataplan.adapters.TeletalkFnFServiceAdapter;
...
public class TeletalkFnFFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        TeletalkFnFServiceAdapter mAdapter = new TeletalkFnFServiceAdapter(mContext);
