...
import com.walton.internetdataplan.adapters.TeletalkMiscAdapter;
...
public class TeletalkMiscFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        TeletalkMiscAdapter mAdapter = new TeletalkMiscAdapter(mContext);
