...
import com.walton.internetdataplan.adapters.GPMigrationAdapter;
...
public class GPMigrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {
            AppManager.getInstance(mContext).retrieveMigrationList(mContext, AppConstants.MIGRATION_GRAMEENPHONE, "");
        }
        else
        {
            AppManager.getInstance(mContext).retrieveMigrationList(mContext, AppConstants.MIGRATION_GRAMEENPHONE_BN, "");
        }
       ...
       // Toast.makeText(mContext,"size:aa:"+mGPMigrationList.size(),Toast.LENGTH_SHORT).show();
        GPMigrationAdapter mAdapter = new GPMigrationAdapter(mContext, AppManager.mMigrationList, false);
