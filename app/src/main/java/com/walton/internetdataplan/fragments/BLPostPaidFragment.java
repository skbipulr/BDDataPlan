...
public class BLPostPaidFragment extends Fragment {
    public static RecyclerView recyclerView;
    public Context mContext;
    BLPostPaidAdapter blAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        BLPostPaidFragment.MyAsyncTask myAsyncTask = new BLPostPaidFragment.MyAsyncTask();
        myAsyncTask.execute();
    ...
    public class MyAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            blAdapter = new BLPostPaidAdapter(mContext, AppManager.mBLPostpaidDataPackList, false);
