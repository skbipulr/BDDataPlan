...
import com.walton.internetdataplan.adapters.BLMiscAdapter;
...
public class BLMiscFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        BLMiscAdapter mAdapter = new BLMiscAdapter(mContext);
