...
import com.walton.internetdataplan.adapters.BLMigrationAdapter;
...
public class BLMigrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (AppsSettings.getAppsSettings(mContext).getLanguage().equals("eng")) {
            AppManager.getInstance(mContext).retrieveMigrationList(mContext, AppConstants.MIGRATION_BANGLALINK, "");
        } else {
            AppManager.getInstance(mContext).retrieveMigrationList(mContext, AppConstants.MIGRATION_BANGLALINK_BN, "");
        }


        BLMigrationAdapter mAdapter = new BLMigrationAdapter(mContext, AppManager.mMigrationList, false);
