...
import com.walton.internetdataplan.adapters.RobiFnFAdapter;
...
public class RobiFnFFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RobiFnFAdapter gpAdapter=new RobiFnFAdapter(mContext);
