...
public class RobiPrepaidFragment extends Fragment {
    public static RecyclerView recyclerView;
    public Context mContext;
    RobiPrepaidAdapter robiAdapter;
...
//        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.recycler_view_layout, container, false);
        ...
        RobiPrepaidFragment.MyAsyncTask myAsyncTask = new RobiPrepaidFragment.MyAsyncTask();
        myAsyncTask.execute();
    ...
    public class MyAsyncTask extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            robiAdapter = new RobiPrepaidAdapter(mContext, AppManager.mRobiPrepaidDataPackList, false);
