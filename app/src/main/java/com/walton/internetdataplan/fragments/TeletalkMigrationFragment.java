...
import com.walton.internetdataplan.adapters.TeletalkMigrationAdapter;
...
public class TeletalkMigrationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {
            AppManager.getInstance(mContext).retrieveMigrationList(mContext, AppConstants.MIGRATION_TELETALK, "");
        }
        else
        {
            AppManager.getInstance(mContext).retrieveMigrationList(mContext, AppConstants.MIGRATION_TELETALK_BN, "");
        }

        TeletalkMigrationAdapter mAdapter = new TeletalkMigrationAdapter(mContext, AppManager.mMigrationList, false);
